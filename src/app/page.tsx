...
export default function Home() {
  ...
  const renderDiamonds = () => {
    return [...Array(12)].map((_, i) => (
      ...
      >
        <Image src="/asset/diamond.svg" alt="Diamond" width={30} height={30} priority unoptimized />
      </div>
    ));
  };
  ...
  useEffect(() => {
    ...
    const imageUrls = ["/asset/background.svg", "/img/profile.jpg", "/asset/moon.svg", "/asset/lentera-1.svg", "/asset/lentera-2.svg"];
  ...
  return (
    <>
      ...
      {/* Ornamen Background */}
      {showDecorations && <div className="ornaments-container">{renderOrnaments()}</div>}

      {/* Diamonds Container */}
      {showDecorations && <div className="diamonds-container">{renderDiamonds()}</div>}
        ...
        <div className="fullscreen-container step-1 animate-fade-in">
          <div className="centered-content">
            ...
            <div className="mosque-container">
              <Image src="/img/mosque.svg" alt="Masjid" width={150} height={150} className="mosque-animation" priority unoptimized />
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fullscreen-container step-2 animate-fade-in">
          <div className="centered-content">
            ...
            <div className="svg-container lantern-animation">
              <Image src="/asset/lentera-1.svg" alt="Lentera" width={100} height={100} className="svg-animation lantern-left" priority unoptimized />
              <Image src="/asset/moon.svg" alt="Bulan Sabit" width={120} height={120} className="svg-animation moon-center" priority unoptimized />
              <Image src="/asset/lentera-2.svg" alt="Lentera" width={100} height={100} className="svg-animation lantern-right" priority unoptimized />
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fullscreen-container step-3 animate-fade-in">
          <div className="chat-container">
            <div className="chat-bubble">
              <p>
                {typedText}
                <span className={isTypingComplete ? "hidden" : "cursor"}></span>
              </p>
            </div>
            {isTypingComplete && (
        ...
        <div className="fullscreen-container step-4 animate-fade-in">
          <div className="centered-content">
            ...
            <div className="bedug-container">
              <Image src="/img/bedug.svg" alt="Bedug" width={120} height={120} className="bedug-animation" priority unoptimized />
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fullscreen-container step-5 animate-fade-in">
          <div className="centered-content">
            ...
            <div className="praying-container">
              <Image src="/img/praying.svg" alt="Praying" width={150} height={150} className="praying-animation" priority unoptimized />
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fullscreen-container step-6 animate-fade-in">
          <div className="centered-content sparkles-container">
            ...
            <div className="sparkles-wrapper">
              <SparklesCore background="transparent" minSize={0.6} maxSize={1.4} particleDensity={70} className="w-full h-full absolute top-0 left-0" particleColor="#FFD700" speed={1} />
            </div>

            <div className="alquran-container">
              <Image src="/img/alquran.svg" alt="Al-Quran" width={100} height={100} className="alquran-animation" priority unoptimized />
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fullscreen-container step-7 animate-fade-in">
          <div className="centered-content">
            ...
            <div className="crescent-animation-container">
              <Image src="/img/crescent-moon.svg" alt="Bulan Sabit" width={120} height={120} className="crescent-moon-animation" priority unoptimized />
            </div>
          </div>
        </div>
      )}
      ...
      {currentStep === 8 && (
        <div className="fullscreen-container step-8 animate-fade-in">
          <div className="centered-content">
            ...
            <button onClick={() => setCurrentStep(9)} className="continue-btn blink-me" style={{ marginTop: "30px" }}>
              Lanjutkan
            </button>
          </div>
          {showLanterns && (
        ...
        <div className="fullscreen-container step-9 animate-fade-in">
          ...
          <div className="crescent-container">
            {[...Array(10)].map((_, i) => (
              ...
              >
                <Image src="/asset/moon.svg" alt="Bulan Sabit" width={80} height={80} className="moon-svg" priority unoptimized />
              </div>
            ))}
          </div>
          ...
          <div className="ornaments-container">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className={`ornament hover-float ${i % 3 === 0 ? "ornament-yellow-big" : i % 3 === 1 ? "ornament-green-medium" : "ornament-yellow-small"}`}
                style={{
                  left: `${15 + i * 15}%`,
                  top: `${10 + (i % 3) * 20}%`,
              ...
              >
                <Image src={i % 2 === 0 ? "/asset/yellow-small.svg" : "/asset/green-small.svg"} alt="Ornament" width={i % 3 === 0 ? 120 : 80} height={i % 3 === 0 ? 120 : 80} priority unoptimized />
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="parallax-bg">
        ...
        >
          <Image src="/asset/green-big.svg" alt="Background Layer" fill style={{ objectFit: "cover" }} priority unoptimized />
        </div>
        <div
        ...
        >
          <Image src="/asset/yellow-big.svg" alt="Background Layer" fill style={{ objectFit: "cover" }} priority unoptimized />
        </div>
